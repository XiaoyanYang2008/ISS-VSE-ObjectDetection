...
python3 FasterRCNNModel.py -m test-video -p data/test/1-test-video.avi --gpu 0 --network resnet50 --config_filename rmconfig.pickle --input_weight_path rm-model.hdf5
